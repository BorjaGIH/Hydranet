...
def make_hydranet(input_dim, num_treats, reg_l2):
    ...
    if num_treats==10:
        ...
        y8_hidden = Dense(units=100, activation='elu', kernel_regularizer=regularizers.l2(reg_l2))(x)
        y9_hidden = Dense(units=100, activation='elu', kernel_regularizer=regularizers.l2(reg_l2))(x)
    ...
    if num_treats==10:
        ...
        y8_hidden = Dense(units=100, activation='elu', kernel_regularizer=regularizers.l2(reg_l2))(y8_hidden)
        y9_hidden = Dense(units=100, activation='elu', kernel_regularizer=regularizers.l2(reg_l2))(y9_hidden)
    ...
    if num_treats==10:
        ...
        y8_predictions = Dense(units=1, activation=None, kernel_regularizer=regularizers.l2(reg_l2),name='y8_predictions')(y8_hidden)
        y9_predictions = Dense(units=1, activation=None, kernel_regularizer=regularizers.l2(reg_l2),name='y9_predictions')(y9_hidden)
